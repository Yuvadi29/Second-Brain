...
"[project]/lib/extractGithubFile.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"601a496129d046929db6646e9309d373bdc8f289f4":"extractTextFromGithubFile"},"",""] */ __turbopack_context__.s([
...
async function extractTextFromGithubFile(path, ref) {
    ...
    if (!res.ok) {
        console.error("[extractGithubFile] GitHub error", res.status, await res.text());
        return null;
    }
    ...
    if (ext === "pdf") {
        const parsed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$parse$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(buffer);
        return parsed.text;
    }
    if (ext === "docx") {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(extractTextFromGithubFile, "601a496129d046929db6646e9309d373bdc8f289f4", null);
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$extractGithubFile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/extractGithubFile.ts [app-route] (ecmascript)");
...
async function POST(req) {
    ...
    for (const path of touchedFiles){
        const text = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$extractGithubFile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["extractTextFromGithubFile"])(path, afterSha);
        if (!text) {
            console.warn("[webhook] No text extracted for", path);
            continue;
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$chunkAndIngest$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ingestTextIntoChroma"])("secondbrain", path, text, {
            ref: afterSha
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__76af47e8._.js.map