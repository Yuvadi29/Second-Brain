...
//     // Build citations array for frontend
//     const citations = docs?.map((doc, i) => {
//         const meta = metas[i] || {};
...
//             source,
//             chunkIndex,
//             preview: doc.substring(0, 150) + (doc.length > 150 ? "..." : "")
//         };
//     });
...
// - At the end of your response, include a "Sources:" section listing the files you referenced.
// Example format:
// Your answer here [1]. Additional info [2].
// **Sources:**
// [1] filename.md (chunk 0)
// [2] another-file.md (chunk 1)
// `.trim();
